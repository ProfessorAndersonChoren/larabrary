...
<body class="bg-red-200 ">
    <header class="flex items-center justify-between w-full px-8 py-4 bg-red-500">
        <div class="flex items-center gap-4">
            ...
            <nav>
                <a href="{{ route('dashboard') }}" class="pr-4 custom-link-menu">Dashboard</a>
                <a href="{{ route('new-book') }}" class="custom-link-menu">Cadastrar novo livro</a>
            </nav>
        </div>
        <div id="drop-down" class="flex flex-col items-end">
            ...
            <div id="drop-down-menu" class="hidden w-32 p-4 bg-white rounded-md">
                <a href="/logout" class="custom-link-menu-item">Logout</a>
            </div>
        </div>
    </header>
